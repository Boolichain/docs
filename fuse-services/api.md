...
The Booli Studio REST API for accessing the data and the services of the Booli network in a simple way. You can use this API to query and interact with the objects of the Booli network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Booli network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Booli\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Booli network |
...
| homeBridgeAddress | `String` | Bridge address on the Booli network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Booli network |
...
Community is a set of contracts and services. Members of the community are users of the Booli network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Booli network |
| homeTokenAddress | `String` | Address of the community token on the Booli network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Booli network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Booli network |
...
Entity is an account on the Booli network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Booli network |
...
Tokens are compatible with the BOOLI20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
