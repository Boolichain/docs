---
description: Steps to transfer/wrap BOOLI20 tokens from Ethereum to Fusenet
---

# Bridge for BOOLI20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Booli explorer to relay the tokens.
