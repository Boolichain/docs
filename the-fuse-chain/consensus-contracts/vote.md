...
Booli chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://booliscan.com/address/0x21639E5364dc91cB20b1D909FDeb4A3dfa7b4134) with the following params:
...
Some other useful functions on the [voting contract](https://booliscan.com/address/0x21639E5364dc91cB20b1D909FDeb4A3dfa7b4134) are:
